...
DROP PROCEDURE verTodo();


CREATE TRIGGER before_insert_pelicula BEFORE INSERT ON pelicula
FOR EACH ROW
BEGIN
...
INSERT INTO pelicula (titulo, director,actor, imagen) VALUES( 'Taxi Driver', 'Martin Scorsese','Marco Algalan','imagen5.jpg' );

DROP TRIGGER before_insert_pelicula;
