        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="mdjuegos.php">
  ...
  <section class="slider_section ">
    <div class="container ">
      ...
      <div class="find_container " style="display: flex; justify-content: center; flex-direction: column; align-items: center;">
        ...
        $resultadoA = mysqli_query($link,$sql);
        echo"<table class='styled-table' border='1'>";
        echo"<TR><th>Id usuario</th><th>Nombre</th><th>Apellido</th><th>Usuario</th><th>tipo</th></TR>";
        while($res=mysqli_fetch_array($resultadoA))
        {
        $id=$res['id_usuario'];
        $nm=$res['nombre'];
        ...
        $us=$res['usuario'];
        $tp=$res['tipo'];
        echo"<TR><TD>$id</TD><TD>$nm</TD><TD>$ap</TD><TD>$us</TD><TD>$tp</TD></TR>";
        }
        echo"</table>";
        ?>
      </div>
